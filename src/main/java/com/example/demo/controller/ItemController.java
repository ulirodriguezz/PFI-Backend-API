...
public class ItemController {
    ...
    public ResponseEntity<SimpleItemDTO> getItemByTagId(
            @PathVariable String tagId
    ) {
        SimpleItemDTO itemDTO = itemService.getItemByTagId(tagId);
    ...
    @PatchMapping("/items/{tagId}/mark-in-use")
    public ResponseEntity<SimpleItemDTO> markItemAsInUse(@RequestHeader("Authorization") String authHeader, @PathVariable String tagId, @RequestBody SimpleItemDTO itemData) {
        SimpleItemDTO itemDTO = itemService.markInUse(tagId, getUsernameFromHeader(authHeader));
        return ResponseEntity.status(HttpStatus.OK).body(itemDTO);
    }
