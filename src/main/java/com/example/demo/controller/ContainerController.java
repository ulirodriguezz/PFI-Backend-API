...
public class ContainerController {
    ...
    @GetMapping("containers/by-tag/{tagId}")
    public ResponseEntity<FullContainerDTO> getItemByTagId(
            @PathVariable String tagId
    ) {
        FullContainerDTO containerDto = containerService.getContainerByTagId(tagId);
